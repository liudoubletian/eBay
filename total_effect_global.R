...
N.sam=50
new_tree_power_samll_effect=matrix(rep(0,4*12),ncol=12)
...
for (h in 1: 6){
  ...
  control_theta=case_theta=rep( mean(the_eff),pre_tree$Nnode)
  case_pi=control_pi=c()
...
write.table(new_tree_power_samll_effect[1:4,],"/export/home/yangsheng/double/emp_norm/algtotal_effect_global.txt")
