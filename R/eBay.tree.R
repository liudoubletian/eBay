...
#' @param group the group label for each sample
#' @param g the internal node of the tree
#' @param tree_table the total data set including the internal nodes and leaf nodes count
